...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <link rel="stylesheet" href="/styles/prism-okaidia.css" />
        <style>
          .copied {
            position: relative;
          }
        ...
        <main>
          ...
          <p>
            <pre class="language-text">
              <code id="feedurl" class="language-text">
                <xsl:value-of select="/atom:feed/atom:link[@rel='self']/@href"/>
              </code>
            </pre>
            <button class="clipboard" data-clipboard-target="#feedurl">
              Copy to clipboard
            </button>
          </p>
          <hr />
 ...
 news items.</p>
        ...
        <script>
      let button = document.querySelector("button.clipboard");
      let text = document.getElementById("feedurl").innerHTML;
